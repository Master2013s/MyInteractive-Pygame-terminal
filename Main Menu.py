...
# pygame.mixer.pre_init(44100, -16, 2, 512)  # Removed pre_init to avoid Windows audio device issues
pygame.init()
audio_enabled = True
try:
    pygame.mixer.init()  # Initialize mixer after pygame.init() for Windows compatibility
except pygame.error as e:
    print(f"Audio mixer init failed: {e}. Audio will be disabled.")
    audio_enabled = False
size = (1000, 500)
...
# Add initial tabs
add_tab('terminal', 'Terminal', 'terminal')
add_tab('other', 'Other', 'other')

# Set the callback for shell to create tabs
